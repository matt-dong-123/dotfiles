...
5. Find and install tokyo night themes for GitHub, Reddit, ChatGPT, and Brave Search by JoshuaMarkle as well as installing "Desmos Dark Theme" by spidunno via Stylus
...
9.
#+BEGIN_SRC sh
bash <(curl -s https://raw.githubusercontent.com/soulhotel/git-userChrome/main/scripts/gituserChrome.sh) https://github.com/adriankarlen/textfox.git
#+END_SRC
** LeaderKey

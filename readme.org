...
6. Find and install tokyo night themes for GitHub, Reddit, ChatGPT, and Brave Search by JoshuaMarkle as well as installing "Desmos Dark Theme" by spidunno via Stylus
7. Copy the user.js in ~/.config/zen to your profile directory
8. Delete the user.js after starting the browser (settings will be remembered automatically)
9. Install [[https://github.com/CosmoCreeper/Sine][Sine mods]]
10. Install Nebula
11. Disable loading animation in Nebula settings
** LeaderKey

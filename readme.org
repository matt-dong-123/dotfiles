...
2. Install the following addons:
    ...
    - SponsorBlock
    - Zen Internet
3. Disable 'immersive search' and 'hide filter chips' on youtube
4. Go to Zen Internet's Advanced settings and turn on the toggle for "Disable Transparency"
5. Copy the user.js in ~/.config/firefox to your profile directory
...
1. Download and run the latest natsumi installer
** LeaderKey
